...
//it helps when accessing nested properties and nested objects
console.log(fetchedUserData?.job?.title);

//nullish coalescing 
const userInputValue = '';
//if it is null or undefined then use 'DEFAULT' as its value
const storeData = userInputValue ?? 'DEFAULT';
